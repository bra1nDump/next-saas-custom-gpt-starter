...
declare module "next-auth" {
  ...
  interface User {
    ...
    stripePlanActiveUntil?: Date;
    stripeSubscriptionCancelationScheduledOn?: Date;
  }
}
    ...
    async session({ session, user }) {
      ...
      return {
        ...
        user: {
          ...
          stripePriceId: dbUser?.stripePriceId ?? undefined,
          stripePlanActiveUntil: dbUser?.stripePlanActiveUntil ?? undefined,
          stripeSubscriptionCancelationScheduledOn:
            dbUser?.stripeSubscriptionCancelationScheduledOn ?? undefined,
        },
      };
    },
  },
